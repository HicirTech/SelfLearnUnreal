...
#define ORIGINAL_FILE_NAME "UE4Editor-SelfLearnUnreal1.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME SelfLearnUnreal1
#define DEPRECATED_FORGAME DEPRECATED
#define SELFLEARNUNREAL1_API DLLEXPORT
